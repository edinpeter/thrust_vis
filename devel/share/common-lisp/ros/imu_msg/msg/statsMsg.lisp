...
(cl:defmethod cl:initialize-instance :after ((m <statsMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'statsMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_msg-msg:<statsMsg> is deprecated: use imu_msg-msg:statsMsg instead.")))

(cl:ensure-generic-function 'xSD-val :lambda-list '(m))
(cl:defmethod xSD-val ((m <statsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_msg-msg:xSD-val is deprecated.  Use imu_msg-msg:xSD instead.")
  (xSD m))

(cl:ensure-generic-function 'ySD-val :lambda-list '(m))
(cl:defmethod ySD-val ((m <statsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_msg-msg:ySD-val is deprecated.  Use imu_msg-msg:ySD instead.")
  (ySD m))

(cl:ensure-generic-function 'xCent-val :lambda-list '(m))
(cl:defmethod xCent-val ((m <statsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_msg-msg:xCent-val is deprecated.  Use imu_msg-msg:xCent instead.")
  (xCent m))

(cl:ensure-generic-function 'yCent-val :lambda-list '(m))
(cl:defmethod yCent-val ((m <statsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_msg-msg:yCent-val is deprecated.  Use imu_msg-msg:yCent instead.")
  (yCent m))
