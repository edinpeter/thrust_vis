...
if("TRUE" STREQUAL "TRUE")
  set(imu_3dm_gx4_SOURCE_PREFIX /home/kamille/thrust_vis/src/imu)
  set(imu_3dm_gx4_DEVEL_PREFIX /home/kamille/thrust_vis/devel)
  ...
  set(imu_3dm_gx4_INSTALL_PREFIX /home/kamille/thrust_vis/install)
...
if(NOT "/home/kamille/thrust_vis/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kamille/thrust_vis/src/imu/${idir}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
    endif()
